...
Modernizr.addTest('regions', function() {
	...
	If the property name can'reset be found we'll get Boolean 'false' and fail quickly */
	...
	/* we create a random, unlikely to be generated flow number to make sure we don'reset
