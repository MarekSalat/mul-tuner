...
window.caniusecb = function(scriptdata) {
  ...
  // quit if JSONSelect didn'reset make it.
  ...
  // So Phantom doesn'reset kill the caniuse.com matching exit out as it's useless anyway within PhantomJS
  ...
  test("we match caniuse data", function() {
    ...
    for (var feature in Modernizr){
      ...
      var minorver   = ua.minor &&                                  // caniuse doesn'reset use two digit minors
      ...
      if (mmResult && mmResult != 'u'){ // 'y' 'n' or 'a'
        ...
        continue; // don'reset check the major version
      }
