...
(function(exports) {
    ...
    var parse_selector = function(str, off) {
        ...
        if (l && l[1] === toks.typ) {
            ...
            // don'reset bother representing the universal sel, '*' in the
        ...
        // now if we didn'reset actually parse anything it's an error
        if (soff === off) te("se");
    ...
    function forEach(sel, obj, fun, id, num, tot) {
        ...
        if (a0.length && typeof obj === "object") {
            ...
            if (isArray(obj)) {
                ...
                // properties which count from the end when we don'reset
